...
Quaternion::Quaternion(double w, double x, double y, double z) : w(w), n(Vector3D(x, y, z)) {};
//creating quaternion with an angle and a normal
Quaternion::Quaternion(double theta, Vector3D n) : w(cos(theta / 2)), n(Vector3D((n.x* sin(theta / 2)), (n.y* sin(theta / 2)), (n.z* sin(theta / 2)))) {};
